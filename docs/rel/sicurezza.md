...
I token vengono poi portati in tutte le richieste uteten e, una volta arrivati a backend vengono letti utilizzando la loro chiave pubblica richiesta tramite un endpoint di Keycloak.
